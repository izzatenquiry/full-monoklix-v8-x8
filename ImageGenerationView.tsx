...
const ImageGenerationView: React.FC<ImageGenerationViewProps> = ({ onCreateVideo, onReEdit, imageToReEdit, clearReEdit, presetPrompt, clearPresetPrompt, currentUser, onUserUpdate }) => {
  ...
  }, [generateOneImage, setStatusMessage]);
  ...
  const leftPanel = (
    <>
      ...
      <details className={`pt-4 border-t border-gray-200 dark:border-gray-700`}>
          <summary className={`font-semibold cursor-pointer`}>Advanced Prompt Builder</summary>
          <fieldset className="mt-4 space-y-4">
              <p className="text-xs text-gray-500 dark:text-gray-400">Select options to append them to your prompt.</p>
